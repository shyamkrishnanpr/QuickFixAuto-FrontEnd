...
import { GetPrivateChatMessages,GetConversationMessages } from '../../store/reducers/vendor/chatServiceSlice';

const ChatBox = ({vendorId,userId,setUnread,setLastMessageStatus,lastMessageStatus}) => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-start min-h-[300px] sm:min-h-[500px] md:min-h-[500px] lg:min-h-[400px] xl:min-h-[600px]  text-gray-800">
        {/* Component Start */}
